...
import com.areeoh.clans.events.ClanPillageEndEvent;
...
public class PillageListener extends Module<PillageManager> implements Listener, Updater {
    ...
    public void onPillage(ClanPillageStartEvent event) {
        ...
        getManager().addPillage(new Pillage(killer, dead));
    ...
    public void onPillageEnd(ClanPillageEndEvent event) {
        ...
        pillagee.inform(true, "Clans", "The Pillage on your Clan has finished!", null);
        pillager.inform(true, "Clans", "The Pillage on " + ChatColor.YELLOW + "Clan " + pillagee.getName() + ChatColor.GRAY + " has finished!", null);
    }
}
