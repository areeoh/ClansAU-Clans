...
import com.areeoh.clans.events.ClanRevokeTrustEvent;
import com.areeoh.clans.events.ClanTrustEvent;
...
public class ClanTrustCommand extends Command<Player> {
    ...
    public boolean execute(Player player, String[] args) {
        ...
        if (!clan.getTrustRequestMap().containsKey(target.getName())) {
            ...
            target.inform(true, "Clans", clanRelation.getSuffix() + "Clan " + clan.getName() + ChatColor.GRAY + " has requested trust with your Clan.", null);
            return true;
        }
