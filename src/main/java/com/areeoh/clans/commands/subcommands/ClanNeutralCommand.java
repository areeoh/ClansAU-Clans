...
import com.areeoh.clans.events.ClanNeutralEvent;
...
public class ClanNeutralCommand extends Command<Player> {
    ...
    public boolean execute(Player player, String[] args) {
        ...
        if (!clan.getNeutralRequestMap().containsKey(target.getName())) {
            ...
            target.inform(true, "Clans", getManager(ClanManager.class).getClanRelation(clan, target).getSuffix() + "Clan " + clan.getName() + ChatColor.GRAY + " has requested neutrality with your Clan.", null);
            return true;
        }
